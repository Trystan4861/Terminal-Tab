...
- ✅ Internacionalización básica (incluye soporte en español mediante `package.nls.es.json`).
...
Este archivo será actualizado en futuras versiones para reflejar mejoras, nuevas funcionalidades y correcciones de errores.
